...
\end{minted}
 \mintinline[fontsize=\footnotesize]{javascript}{0 = this.drawUsernameBox}, \mintinline[fontsize=\footnotesize]{javascript}{1 = this.drawTokenBox} \\
...
\end{lstlisting} 
\vspace*{1\baselineskip}
\textbf{Description}: Called whenever the \mintinline[fontsize=\footnotesize]{javascript}{General::function keyPressed()} function routes the signal to this function. a.k.a whenver \mintinline[fontsize=\footnotesize]{javascript}{gameState == 0}. This function first checks the \mintinline[fontsize=\footnotesize]{javascript}{this.gameStateStartScreen} like so: \\\mintinline[fontsize=\footnotesize]{javascript}{switch(this.gameStateStartScreen)} \\\mintinline[fontsize=\footnotesize]{javascript}{case 1:} \\\mintinline[fontsize=\footnotesize]{javascript}{ ...} \\\mintinline[fontsize=\footnotesize]{javascript}{case 2:} \\\mintinline[fontsize=\footnotesize]{javascript}{ ...} \\From here, we can figure out where the user is trying to type and add the types characters accoridngly. \\
